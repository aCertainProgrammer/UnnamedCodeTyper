const defaultData = `import { capitalize, prettifyChampionName } from "../util.js";
import TierEditorView from "./tier_editor_view.js";
export default class TierView {
	constructor(tierViewModel, tierlistViewModel, tierContainer, tierlistRenderSignal, tierIndex) {
